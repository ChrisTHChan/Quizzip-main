        ...
        <div className="py-10 flex justify-center items-center">
          <div className="container">
            <div className="mb-16 container w-11/12 mx-auto leading-loose">
              <h2 className="text-4xl md:text-6xl font-extrabold text-center mb-10">Terms of <span className="text-blue-500">Service Policy.</span></h2>
              <p>By using the QuizzipIO.com ("Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service") by QuizzipIO ("Company").</p>
              <h3 className="mb-4 font-semibold">Account Terms</h3>
              <ol className="list-decimal mb-4 ml-4">
                ...
                <li>You may not created more than one account.</li>
              </ol>
              <h3 className="mb-4 font-semibold">Payment, Upgrading and Downgrading Terms</h3>
              <ol className="list-decimal mb-4 ml-4">
                ...
                <li>All fees are exclusive of all taxes, levies, or duties imposed by taxing authorities, and you shall be responsible for payment of all such taxes, levies, or duties. Where required, The Company will collect those taxes on behalf of taxing authority and remit those taxes to taxing authorities.</li>
              </ol>
              <h3 className="mb-4 font-semibold">Cancellation and Termination</h3>
              <ol className="list-decimal mb-4 ml-4">
                ...
                <li>All of your content will be inaccessible from the Service immediately upon cancellation. Within 30 days, all content will be permanently deleted from active systems and logs. Within 60 days, all content will be permanently deleted from our backups. This information can not be recovered once it has been permanently deleted.</li>
              ...
              <h3 className="mb-4 font-semibold">Modifications to the Service and Prices</h3>
              <ol className="list-decimal mb-4 ml-4">
                ...
                <li>Prices of all Services are subject to change upon 7 days notice from us. Such notice may be provided at any time by posting the changes to the Company web site or the Service itself.</li>
              ...
              <h3 className="mb-4 font-semibold">Copyright and Content Ownership</h3>
              <ol className="list-decimal mb-4 ml-4">
              ...
              <h3 className="mb-4 font-semibold">General Conditions</h3>
              <ol className="list-decimal mb-4 ml-4">
                <li>Your use of the Service is at your sole risk. The service is provided on an “as is” and “as available” basis.</li>
                <li>Technical support is only provided via email at quizzipio@gmail.com.</li>
                ...
                <li>Questions about the Terms of Service should be sent to quizzipio@gmail.com</li>
                <li>Any new features that augment or enhance the current Service, including the release of new tools and resources, shall be subject to the Terms of Service. Continued use of the Service after any such changes shall constitute your consent to such changes.</li>
              </ol>
              <h3 className="mb-4 font-semibold ">Liability</h3>
