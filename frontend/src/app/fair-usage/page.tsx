        ...
        <div className="py-10 flex justify-center items-center">
          <div className="container">
            <div className="mb-16 container w-11/12 md:w-4/5 xl:w-2/5 mx-auto leading-loose">
              ...
              <p className="text-center mb-4">To avoid overloading our systems, all accounts across all plans are limited dynamically on a per-minute, per-hour and per-month basis. This way, if you haven't used the product much the previous hour, or month, you will have a higher allowance. We also have various bot prevention measures in place. Most users won't encounter these limits. If you do, please wait a minute before trying again.</p>
              ...
              <p className="text-center mb-4">We strive to ensure QuizzipIO's sustainability while providing the best possible service to our users. We'll continue to monitor usage and update our policies as needed to ensure that QuizzipIO remains accessible and affordable for everyone.</p>
            </div>
          </div>
        </div>
        <Footer/>
